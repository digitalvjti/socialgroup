  ...
  return (
    ...
    <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
        ...
        <div>
            ...
            &nbsp;
            &nbsp;
            <a onMouseEnter={() => setHoveredInstagram(true)} onMouseLeave={() => setHoveredInstagram(false)} href="https://www.instagram.com/dla_vjti/" className=' md:text-xl text-white font-semibold inline-block'>
                Visit Instagram
    ...
    <div className='overflow-hidden rounded-s-lg z-[1] flex-1 shadow-3xl'>
        ...
        <Image
        src="/dla.png" // Path from the public directory
