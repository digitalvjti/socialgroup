...
const ContentDigital = (props: Props) => {
  ...
  return (
    ...
    <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Digital VJTI</span> is the one projecting social life of VJTI to the world, imbibe technology with tradition and are the backend of VJTI Social group</p>
        <div>
    ...
    <div className='overflow-hidden rounded-s-lg z-[1] flex-1 shadow-3xl'>
        ...
        <Image
        src="/digital.png" // Path from the public directory
        alt="Your Image Description"
        width={275} // Set the width
        height={275} // Set the height
        style={{ marginLeft: '75px', marginTop: '45px', objectFit: 'cover', objectPosition: 'center' }} // Adjust values as needed
      />
        {/* </div> */}
    </div>
</HoverCard>
