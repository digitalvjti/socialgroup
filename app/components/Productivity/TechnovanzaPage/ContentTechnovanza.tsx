...
const ContentTechnovanza = (props: Props) => {
  ...
  return (
    ...
    <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
        ...
        <div>
            ...
            &nbsp;
            &nbsp;
            <a onMouseEnter={() => setHoveredInstagram(true)} onMouseLeave={() => setHoveredInstagram(false)} href="https://www.instagram.com/technovanza/" className=' md:text-xl text-white font-semibold inline-block'>
                Visit Instagram
