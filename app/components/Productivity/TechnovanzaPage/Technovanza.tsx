...
//         <motion.div variants={lineVariant} initial='hidden' whileInView='show' viewport={{once:false}} transition={{duration:0.3}}  className='w-[3px] h-full increase origin-top bg-blue-500' style={{ backgroundColor: '#33b3ae !important' }}></motion.div>
//         <img
//             alt=""
//             aria-hidden="true"
//             width="81"
...
//                 {/* <div className='z-[1] inline-block rounded-full px-2 border-2 border-[#33b3ae] relative font-medium bg-gradient-to-r from-[#33b3ae] to-[#aff5b4] bg-clip-text text-transparent'>
//                     <span className='font-semibold text-[12px]'>Did you know?</span>
//                 </div> */}
//                 <h3 className="text-[#33b3ae] mb-12 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">TECHNOVANZA</h3>
...
const Technovanza = (props: Props) => {
  ...
  return (
    ...
    <div className='lg:pl-24 md:pl-16 pl-6'>
        ...
        <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{type: "tween", delay:0.1}} className='mb-10 md:mb-32 pb-4 '>
            <div className='py-4 text-left'>
                {/* <div className='z-[1] inline-block rounded-full px-2 border-2 border-[#33b3ae] relative font-medium bg-gradient-to-r from-[#7ee787] to-[#aff5b4] bg-clip-text text-transparent'>
                    <span className='font-semibold text-[12px]'>Did you know?</span>
                </div> */}
                <h3 className="text-[#33b3ae] mb-12 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">TECHNOVANZA</h3>
                {/* <p className="mb-3 md:text-xl text-base font-medium text-white">in developer productivity <br /> after three years with GitHub<sup>1</sup></p> */}
